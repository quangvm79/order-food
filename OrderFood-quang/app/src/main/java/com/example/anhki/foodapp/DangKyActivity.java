...
public class DangKyActivity extends AppCompatActivity implements View.OnClickListener{
    public static int REQUEST_CODE_NHAN_VIEN = 876;
    ...
    private void DongYThemNhanVien(){
        ...
        switch (rgGioiTinh.getCheckedRadioButtonId()){
            ...
            int sCMND;
            try {
                sCMND = Integer.parseInt(edCMND.getText().toString());
            }catch(Exception ex){
                Toast.makeText(DangKyActivity.this, getResources().getString(R.string.loicmnd), Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            if (sTenDangNhap == null || sTenDangNhap.equals("")){
                ...
                Toast.makeText(DangKyActivity.this, getResources().getString(R.string.loingaysinh), Toast.LENGTH_SHORT).show();
                return;
            }
            else {
    ...
    public void onClick(View v) {
        ...
        switch (id){
            ...
            case R.id.btnThoatDK:
                setResult(REQUEST_CODE_NHAN_VIEN);
                finish();
                break;
